# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 16:03:51 2021
...
def Main():
    ...
    root = Tk()
    root.title("Stopwatch made by Lalchan Badsa")
    width = 500
    height = 200
    ...
    Exit.pack(side=LEFT)
    Title = Label(Top, text="StopWatch Created Lalchan Badsa", font=("arial", 24), fg="white", bg="black")
    Title.pack(fill=X)
